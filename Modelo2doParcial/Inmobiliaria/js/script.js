...
$formulario.addEventListener("submit", (e) => {
    ...
    const { titulo, precio, baños, autos, habitaciones, txtId, descripcion, transaccion } = $formulario;
    const anuncioAuxiliar = new Anuncio_Ext(txtId.value, titulo.value, transaccion.value, descripcion.value, precio.value, baños.value, habitaciones.value, autos.value);
